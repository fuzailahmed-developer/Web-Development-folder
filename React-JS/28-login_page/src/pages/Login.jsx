          ...
          <div className='w-[80%] flex flex-col gap-5'>
            ...
            <div className='space-y-5'>
              <label htmlFor='email' className='text-black/40'>
                    Email <br />
                    <input type="email" placeholder='your@gmail.com' id='email' className='w-full border-black/5 text-black/80 border outline-0 h-10 pl-2 rounded mb-5' autoComplete='off'/>
              </label>
              <label htmlFor='password' className='text-black/40'>
                    Password <br />
                    <input type="text" placeholder='********' id='password' className='w-full border-black/5 text-black/80 border outline-0 h-10 pl-2 rounded mb-5' autoComplete='off'/>
              </label>
              <div>
                <button className='bg-purple-700 text-white rounded-lg py-3 font-bold w-full hover:bg-purple-700/80 transition cursor-pointer'>Login</button>
              </div>
              <div>
                <p className='text-sm text-black/60 text-center'>Don't have an account? <span className='text-purple-700 font-semibold cursor-pointer ml-1 hover:text-black/90 transition'><Link to={'/signup'}>Signup</Link></span></p>
              </div>
              <div className='line'>
                <p >OR</p>
              </div>
