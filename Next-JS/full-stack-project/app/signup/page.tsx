    ...
    return (
        <div className="bg-zinc-950 text-white h-screen flex justify-center items-center ">
            <div className="w-full max-w-md  py-7 px-8 rounded-lg border border-white">
                <h1 className="text-2xl mt-1 font-bold mb-5 text-center">Register</h1>
                <FieldSet>
                    <FieldGroup>
                        <Field>
                ...
                <div className="mx-3 flex flex-col gap-y-4">
                    <h1 className="text-sm text-[#dddddd73] flex gap-x-1.5 justify-center mt-5">Already have an account? <span className="text-white font-bold cursor-pointer">Login</span></h1>
